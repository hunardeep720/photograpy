  ...
  return (
    <div style={{backgroundColor:color}} className='fixed left-0 top-0 w-full z-10 ease-in duration-300 h-24'> 
        <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
            ...
            <div className={open? ('sm:hidden absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-end items-center w-44 h-screen bg-black/70 text-center ease-in duration-300'):('sm:hidden absolute top-0 left-[-100%] right-0 bottom-0 flex flex-col justify-end items-center w-44 h-screen bg-black/70 text-center ease-in duration-300')}>
